...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final List<Privilege> managerPrivileges = new ArrayList<>(Arrays.asList(managerPrivilege, readPrivilege,
        ...
        createUserIfNotFound("manager@example.com", "Test", "Manager", "Passw0rd!",
